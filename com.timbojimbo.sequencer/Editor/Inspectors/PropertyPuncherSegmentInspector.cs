...
{
    [CustomSegmentInspector(typeof(PropertyPuncher))]
    public sealed class PropertyPuncherSegmentInspector : SegmentInspector
    {
        public override void OnInspectorGUI(SerializedProperty property)
        {
            ...
            var elasticityProp = property.FindPropertyRelative("Elasticity");
            ...
            EditorGUILayout.Slider(elasticityProp, 0f, 1f, new GUIContent("Elasticity"));
